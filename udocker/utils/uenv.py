...
class UenvIterator(object):
    ...
    def __next__(self):
        """Python 3 next key and value of environment"""
...
class Uenv(object):
    ...
    def __len__(self):
        """Returns the lenght number of env variables"""
        return len(self.env)
    ...
    def appendif(self, envstr):
        """Add var to environment if not existent"""
        (key, val) = get_pair(envstr)
    ...
    def extend(self, envlist):
        """Extend environment add list of vars"""
