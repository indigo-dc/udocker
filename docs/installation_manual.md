...
```bash
wget https://github.com/indigo-dc/udocker/releases/download/v1.3.3/udocker-1.3.3.tar.gz
tar zxvf udocker-1.3.3.tar.gz
...
```bash
curl -L https://github.com/indigo-dc/udocker/releases/download/v1.3.3/udocker-1.3.3.tar.gz \
  > udocker-1.3.3.tar.gz
tar zxvf udocker-1.3.3.tar.gz
export PATH=`pwd`/udocker:$PATH
```
...
```bash
cd /sw
wget https://github.com/indigo-dc/udocker/releases/download/1.3.3/udocker-1.3.3.tar.gz
tar zxvf udocker-1.3.3.tar.gz
```
