...
class NvidiaModeTestCase(TestCase):
    ...
    @patch('engine.nvidia.os.path.exists')
    ...
    @patch('engine.nvidia.os.access')
    @patch('engine.nvidia.stat')
    @patch('engine.nvidia.shutil.copy2')
    @patch('engine.nvidia.os.symlink')
    @patch('engine.nvidia.os.readlink')
    @patch('engine.nvidia.os.chmod')
    @patch('engine.nvidia.os.makedirs')
    @patch('engine.nvidia.os.path.isdir')
    @patch('engine.nvidia.os.path.dirname')
    @patch('engine.nvidia.os.remove')
    @patch('engine.nvidia.os.path.islink')
    @patch('engine.nvidia.os.path.isfile')
    ...
    # @patch('engine.nvidia.os.path.realpath')
    # @patch('engine.nvidia.Uprocess.get_output')
    ...
    @patch('engine.nvidia.FileUtil.putdata')
