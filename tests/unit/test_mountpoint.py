...
class MountPointTestCase(TestCase):
    ...
    @patch('utils.mountpoint.os.path.realpath')
    ...
    @patch('utils.mountpoint.Msg.err')
    @patch('utils.mountpoint.FileUtil.mkdir')
    @patch('utils.mountpoint.os.path.isdir')
    @patch('utils.mountpoint.os.path.realpath')
    ...
    @patch('utils.mountpoint.FileUtil.getvalid_path')
    @patch.object(MountPoint, 'setup')
    @patch('utils.mountpoint.os.path.realpath')
    ...
    @patch('utils.mountpoint.os.path.normpath')
    @patch.object(MountPoint, 'setup')
    @patch('utils.mountpoint.os.path.realpath')
    ...
    @patch('utils.mountpoint.Msg.err')
    @patch('utils.mountpoint.os.path.isdir')
    @patch('utils.mountpoint.os.path.islink')
    @patch('utils.mountpoint.FileUtil.putdata')
    @patch('utils.mountpoint.FileUtil.mkdir')
    @patch('utils.mountpoint.os.path.isfile')
    @patch('utils.mountpoint.os.path.exists')
    @patch.object(MountPoint, 'setup')
    @patch('utils.mountpoint.os.path.realpath')
    ...
    @patch('utils.mountpoint.os.symlink')
    @patch('utils.mountpoint.os.path.exists')
    @patch.object(MountPoint, 'setup')
    @patch('utils.mountpoint.os.path.realpath')
    ...
    @patch('utils.mountpoint.os.readlink')
    @patch('utils.mountpoint.os.listdir')
    @patch.object(MountPoint, 'setup')
    @patch('utils.mountpoint.os.path.realpath')
    ...
    @patch('utils.mountpoint.FileUtil.remove')
