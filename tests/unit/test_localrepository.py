...
class LocalRepositoryTestCase(TestCase):
    ...
    def test_02_setup(self, mock_fu):
        ...
        mock_fu.return_value.register_prefix.side_effect = [None, None, None, None, None, None]
    ...
    @patch('udocker.container.localrepo.os.path.exists')
    @patch('udocker.container.localrepo.FileUtil')
    def test_12_iswriteable_container(self, mock_fu, mock_exists, mock_isdir, mock_access,
                                      mock_cdcont):
    ...
    @patch('udocker.container.localrepo.os.path.isdir')
    @patch('udocker.container.localrepo.FileUtil')
    def test_14_get_containers_list(self, mock_fu, mock_isdir, mock_listdir):
    ...
    @patch('udocker.container.localrepo.FileUtil')
    def test_15_del_container(self, mock_fu, mock_getlist, mock_getname, mock_cdcont, mock_delname):
    ...
    @patch('udocker.container.localrepo.os.path.exists')
    @patch('udocker.container.localrepo.FileUtil')
    def test_16_cd_container(self, mock_fu, mock_exists, mock_getlist):
    ...
    @patch('udocker.container.localrepo.os.path.exists')
    @patch('udocker.container.localrepo.FileUtil')
    def test_17__symlink(self, mock_fu, mock_exists, mock_symlink, mock_relpath):
    ...
    @patch.object(LocalRepository, 'cd_container')
    @patch('udocker.container.localrepo.FileUtil')
    def test_18_set_container_name(self, mock_fu, mock_cd, mock_slink, mock_exists):
    ...
    @patch('udocker.container.localrepo.FileUtil')
    def test_19_del_container_name(self, mock_fu, mock_islink, mock_nameisvalid):
    ...
    @patch('udocker.container.localrepo.os.path.islink')
    @patch('udocker.container.localrepo.FileUtil')
    def test_20_get_container_id(self, mock_fu, mock_islink, mock_isdir, mock_readlink):
    ...
    @patch('udocker.container.localrepo.os.path.isdir')
    @patch('udocker.container.localrepo.FileUtil')
    def test_21_get_container_name(self, mock_fu, mock_isdir, mock_listdir,
    ...
    @patch('udocker.container.localrepo.os.path.exists')
    @patch('udocker.container.localrepo.FileUtil')
    def test_22_setup_container(self, mock_fu, mock_exists, mock_makedirs):
    ...
    @patch('udocker.container.localrepo.os.listdir')
    @patch('udocker.container.localrepo.FileUtil')
    def test_29__inrepository(self, mock_fu, mock_listdir, mock_isdir, mock_islink):
    ...
    @patch('udocker.container.localrepo.FileUtil')
    def test_30__remove_layers(self, mock_fu, mock_in, mock_listdir, mock_islink, mock_readlink):
    ...
    @patch.object(LocalRepository, '_is_tag')
    @patch('udocker.container.localrepo.FileUtil')
    def test_32__get_tags(self, mock_fu, mock_is, mock_listdir, mock_isdir):
    ...
    @patch('udocker.container.localrepo.os.listdir')
    @patch('udocker.container.localrepo.FileUtil')
    def test_34_get_layers(self, mock_fu, mock_ldir, mock_islink, mock_cd):
    ...
    @patch('udocker.container.localrepo.os.path.exists')
    @patch('udocker.container.localrepo.FileUtil')
    def test_35_add_image_layer(self, mock_fu, mock_exists, mock_islink, mock_base, mock_symln):
    ...
    @patch('udocker.container.localrepo.os.path.exists')
    @patch('udocker.container.localrepo.FileUtil')
    def test_42_get_image_attributes(self, mock_fu, mock_exists, mock_loadjson, mock_attrv1,
