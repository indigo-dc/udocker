...
def test_01__load_structure(mocker, ociapi, load_json):
    ...
    mock_oslist = mocker.patch('udocker.oci.os.listdir')
...
def test_02__load_structure(mocker, ociapi, load_json):
    ...
    mock_oslist = mocker.patch('udocker.oci.os.listdir', side_effect=[['f1'], ['f2']])
...
def test_09__load_image_step2(mocker, ociapi):
    ...
    mock_logerr = mocker.patch('udocker.oci.LOG.error')
